...
public class CardSlidePanel extends ViewGroup {
    ...
    private String TAG = CardSlidePanel.class.getSimpleName();
    ...
    private int yOffsetStep = 0; // view叠加垂直偏移量的步长:为零则没有层叠效果
    ...
    //控制切换速度 (// 禁止快速滑动，或者快速点击切换)
    private boolean touchChange=false;
    private long TOUCH_CHANGE_TIME=300;
...
//        bottomMarginTop = (int) a.getDimension(R.styleable.card_bottomMarginTop, bottomMarginTop);//与下边按钮的间隔位置
//        yOffsetStep = (int) a.getDimension(R.styleable.card_yOffsetStep, yOffsetStep);//添加层叠效果
        // 滑动相关类
        ...
        btnListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (view.getId() == R.id.maskView) {
                    ...
                    //最后一张卡片提示
                    if((isShowing+2>=dataList.size())){
                        cardSwitchListener.nextPage();
                    }
                    if(isShowing+1>=dataList.size()){
                        ...
                        touchChange=true;
                        mHandler.sendEmptyMessageDelayed(2, TOUCH_CHANGE_TIME);
            ...
            switch (msg.what){
                case 1:
                    if(cardSwitchListener!=null){
                        cardSwitchListener.onLastCard(isShowing);
                    }
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        public boolean tryCaptureView(View child, int pointerId) {
            ...
            if(touchChange){// 禁止快速滑动，或者快速点击切换
                rightBtn.setEnabled(false);
                leftBtn.setEnabled(false);
                return false;
            }
    ...
    public interface CardSwitchListener {
         ...
         * @param index
         */
        public void onLastCard(int index);
